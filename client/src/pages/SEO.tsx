...
export default function SEO() {
  ...
  return (
    <ARIALayout title="SEO Audits" actions={
      <Button size="sm" className="gap-2 bg-gradient-to-r from-primary to-chart-2 hover:opacity-90" onClick={() => navigate("/?q=Run+an+SEO+audit+for+my+website")}>
        ...
        {isLoading ? (
              ...
              <Card key={a.id} className="bg-card border-border hover:border-primary/30 transition-colors">
                <CardContent className="p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <Button size="sm" variant="outline" className="h-7 gap-1" onClick={() => navigate(`/?q=Improve+SEO+for+${a.url}`)}>
          ...
          <Card className="bg-card border-border border-dashed">
            <CardContent className="p-12 text-center">
              ...
              <Button className="gap-2 bg-gradient-to-r from-primary to-chart-2 hover:opacity-90" onClick={() => navigate("/?q=Run+a+full+SEO+audit+for+my+website")}>
